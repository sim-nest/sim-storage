...
- `crates/sim-artifact-facet/recipes/01-basics/chapter.toml`
- `crates/sim-artifact-facet/recipes/01-basics/pure-three-way/purpose.md`
- `crates/sim-artifact-facet/recipes/01-basics/pure-three-way/recipe.toml`
- `crates/sim-artifact-facet/recipes/01-basics/pure-three-way/setup.siml`
- `crates/sim-artifact-facet/recipes/book.toml`
...
### `feature/sim-storage/artifact-facet-law`

Specimen `spec-test/sim-storage/crates/sim-artifact-facet/tests/facet_law` is checked by `cargo test`.

Source `crates/sim-artifact-facet/tests/facet_law.rs`:
