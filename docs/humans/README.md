...
| --- | --- | ---: | --- |
| `feature/sim-storage/table-dir-backends` | `crate/sim-table-hash` | 2 | Provide hash, lazy, override, mounted, and list-backed Table/Dir implementations for reusable storage libraries. |
